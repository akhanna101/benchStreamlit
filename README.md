...
#To run, clone repo (or drop files) into the directory where you have installed arthur-bench ("steamlitBench.py" should be at the same level as "tests", "docs", "examples", etc.)
